...
async function seed() {
  try {
    ...
    const newsData = [
      {
        titleEn: 'Registration for Semester 5 Now Open', titleAr: 'التسجيل للفصل الخامس مفتوح الآن',
        summaryEn: 'Course registration for the Fall 2025 semester is now open.', summaryAr: 'التسجيل في المقررات للفصل الخريفي 2025 مفتوح الآن.',
        contentEn: 'Dear students, registration for Semester 5 of the academic year 2024-2025 is now open. You can register for your courses through the student portal until October 15th.',
        contentAr: 'أيها الطلاب، التسجيل للفصل الخامس من العام الجامعي 2024-2025 مفتوح الآن. يمكنكم التسجيل في مقرراتكم عبر بوابة الطالب حتى 15 أكتوبر.',
        category: 'announcement', date: new Date('2025-09-01'), author: 'Academic Affairs',
      },
      {
        titleEn: 'Annual Science & Technology Fair', titleAr: 'المعرض السنوي للعلوم و التكنولوجيا',
        summaryEn: 'SITS is hosting its annual Science & Technology Fair.', summaryAr: 'ينظم المعهد معرضه السنوي للعلوم و التكنولوجيا.',
        contentEn: 'The Sabratha Institute of Technical Sciences is proud to announce its 3rd Annual Science and Technology Fair, to be held on November 20-22, 2025.',
        contentAr: 'يعلن معهد صبراتة للتقنية و العلوم التطبيقية عن معرضه السنوي الثالث للعلوم و التكنولوجيا، الذي سيقام في 20-22 نوفمبر 2025.',
        category: 'event', date: new Date('2025-08-28'), author: 'Student Affairs',
      },
      {
        titleEn: 'New Partnership with Libyan Tech Companies', titleAr: 'شراكة جديدة مع شركات التقنية الليبية',
        summaryEn: 'SITS has signed MoUs with leading Libyan technology companies.', summaryAr: 'وقع المعهد مذكرات تفاهم مع شركات تقنية ليبية رائدة.',
        contentEn: 'We are pleased to announce that SITS has signed memoranda of understanding with three leading Libyan technology companies.',
        contentAr: 'يسرنا الإعلان عن توقيع المعهد مذكرات تفاهم مع ثلاث شركات تقنية ليبية رائدة.',
        category: 'announcement', date: new Date('2025-08-20'), author: "Dean's Office",
      },
      {
        titleEn: 'Midterm Exam Schedule Released', titleAr: 'جدول الامتحانات النصفية',
        summaryEn: 'The midterm exam schedule for Semester 5 has been published.', summaryAr: 'تم نشر جدول الامتحانات النصفية للفصل الخامس.',
        contentEn: 'The midterm examination schedule for Semester 5 (2024-2025) is now available. Exams will begin on October 28th.',
        contentAr: 'جدول الامتحانات النصفية للفصل الخامس (2024-2025) متاح الآن. ستبدأ الامتحانات في 28 أكتوبر.',
        category: 'announcement', date: new Date('2025-08-15'), author: 'Examinations Committee',
      },
      {
        titleEn: 'Guest Lecture: AI in Healthcare', titleAr: 'محاضرة ضيف: الذكاء الاصطناعي في الرعاية الصحية',
        summaryEn: 'A guest lecture by Dr. Hassan Al-Mahdi on AI in healthcare.', summaryAr: 'محاضرة ضيف يلقيها د. حسن المهدي حول تطبيقات الذكاء الاصطناعي.',
        contentEn: 'The Computer Engineering Department invites you to a guest lecture by Dr. Hassan Al-Mahdi.',
        contentAr: 'يدعوكم قسم هندسة الحاسوب إلى محاضرة ضيف يلقيها د. حسن المهدي.',
        category: 'event', date: new Date('2025-08-10'), author: 'Computer Engineering Dept.',
      },
      {
        titleEn: 'Library Extended Hours During Exams', titleAr: 'ساعات العمل الموسعة للمكتبة أثناء الامتحانات',
        summaryEn: 'The institute library will remain open until 8 PM during exams.', summaryAr: 'ستظل مكتبة المعهد مفتوحة حتى الساعة 8 مساءً خلال الامتحانات.',
        contentEn: 'To support students during exams, the library will extend its hours from 8:00 AM to 8:00 PM.',
        contentAr: 'دعماً للطلاب خلال الامتحانات، ستمدد المكتبة ساعات عملها من 8:00 صباحاً إلى 8:00 مساءً.',
        category: 'announcement', date: new Date('2025-08-05'), author: 'Library Administration',
      },
    ]
    ...
    console.log('  Student: islam.alhawwari@sits.edu.ly / student123')
    console.log('  Admin:   admin@sits.edu.ly / student123')
